...
export function ImageStreamHero({
  ...
  return (
    ...
    >
      ...
      {/* Vignette keeps the copy readable over the stream. */}
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(5,5,5,0.9)_0%,rgba(5,5,5,0.25)_45%,rgba(5,5,5,0.9)_100%)]" />
