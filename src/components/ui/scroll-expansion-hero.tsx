...
/**
 * Scroll-driven hero: the media panel expands from a card to near-full-bleed
 * as you scroll, then releases the page scroll once fully expanded.
 */
  ...
  useEffect(() => {
    ...
    const handleTouchMove = (e: TouchEvent) => {
      ...
      if (mediaFullyExpanded && deltaY < -20 && window.scrollY <= 5) {
        ...
        e.preventDefault();
        // Higher sensitivity when scrolling back up on touch devices.
